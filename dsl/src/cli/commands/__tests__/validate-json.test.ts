...
`
  ...
  it(
    "emits an ok envelope for a valid project",
    { timeout: 15_000 },
    async () => {
  ...
  it(
    "flips ok and sets exit code 1 on validation errors",
    { timeout: 15_000 },
    async () => {
  ...
  it(
    "emits ok with empty pipelines for a project without pipelines",
    { timeout: 15_000 },
    async () => {
  ...
  it(
    "keeps stdout pure JSON — no human output in JSON mode",
    { timeout: 15_000 },
    async () => {
