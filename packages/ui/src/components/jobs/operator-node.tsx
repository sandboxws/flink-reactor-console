...
import type { TapMetadata } from "../../types"
...
/** Tap session status — extracted from store type to avoid store dependency */
type TapSessionStatus = "connecting" | "streaming" | "paused" | "error" | "closed"

type OperatorNodeData = {
  vertex: JobVertex
  onSelectVertex?: (vertexId: string) => void
  tapMetadata?: TapMetadata
  tapSessionStatus?: TapSessionStatus
