...
export type DashboardConfig = {
  ...
  clusters: Scalars["String"]["output"][]
  instruments: Scalars["String"]["output"][]
}
...
export type DatabaseConstraint = {
  ...
  name: Scalars["String"]["output"]
  refColumns: Scalars["String"]["output"][]
...
export type DatabaseQueryResult = {
  ...
  executionTimeMs: Scalars["Int"]["output"]
  rowCount: Scalars["Int"]["output"]
  rows: Maybe<Maybe<Scalars["JSON"]["output"]>[]>[]
...
export type JmEnvironment = {
  ...
  classpath: Scalars["String"]["output"][]
...
export type JobDetail = {
  ...
  accumulators: Maybe<VertexAccumulators[]>
  backPressure: Maybe<VertexBackPressure[]>
  ...
  vertexDetails: Maybe<VertexDetail[]>
  vertices: JobVertex[]
  watermarks: Maybe<VertexWatermarks[]>
}
...
export type KafkaPartition = {
  ...
  inSyncReplicas: Scalars["Int"]["output"][]
...
export type Query = {
  ...
  databaseQueryHistory: DatabaseQueryHistoryEntry[]
  ...
  databaseTables: DatabaseTableSummary[]
  ...
  kafkaConsumerGroups: KafkaConsumerGroup[]
...
export type SqlFetchResult = {
  ...
  rows: Maybe<Maybe<Scalars["String"]["output"]>[]>[]
}
